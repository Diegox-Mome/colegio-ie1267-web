...
import { MapPin, Mail, Clock, Facebook, MessageCircle, Phone } from 'lucide-react'
    ...
    <div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-6">
        <div className="border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mt-1">ASOC. CASA HUERTA LA CAMPIÑA, MZ O LT 2, Lurigancho, Lima, Perú</p>
        ...
        <div className="border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mt-1">mesadepartes1267@gmail.com</p>
        ...
        <div className="border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mt-1">Lunes a viernes de 8:00 a 4:00 PM</p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-14 grid md:grid-cols-2 gap-8">
        <div className="bg-white border rounded-lg p-6">
          ...
          {sent && (
            <div className="bg-green-50 text-green-700 text-sm rounded-md p-3 mb-4 text-center">
              Se abrió tu cliente de correo con el mensaje listo. Si no se abrió, escríbenos a mesadepartes1267@gmail.com.
            </div>
          )}
        ...
        <div className="space-y-6">
          ...
          <div className="border rounded-lg p-6">
            ...
            <a href="#" className="flex items-center gap-2 text-sm text-gray-600 hover:text-primary-light mb-2">
              <Facebook size={18} /> Facebook Institucional — Mantente al día con nuestras actividades
            </a>
            <p className="flex items-center gap-2 text-sm text-gray-400">
              <MessageCircle size={18} /> WhatsApp Institucional — Próximamente disponible
            </p>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-14 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="tel:0112345670" className="bg-primary text-white px-6 py-3 rounded-md font-semibold flex items-center gap-2 hover:bg-primary-light">
            <Phone size={18} /> Llamar Ahora
          </a>
          <a href="mailto:mesadepartes1267@gmail.com" className="border border-primary text-primary px-6 py-3 rounded-md font-semibold flex items-center gap-2 hover:bg-blue-50">
